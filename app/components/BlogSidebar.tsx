...
export const BlogSidebar = ({
  ...
  return (
    <div className="w-full md:w-fit fixed left-0 p-4 bottom-0 md:top-[4.5rem] md:bottom-auto backdrop-blur-md  bg-white/40 md:bg-transparent  md:left-4 border-t-2 border-black/70 md:border-none">
